...
| Condition | Behaviour |
|---|---|
| `activeWeapon === 'spray_gun'` | Displayed as **Shotgun**. Fires 5 `SprayBullet` in a ±0.35 rad cone. Each bullet travels at 480 px/s up to 320 px. Damage = `atkDmg * 0.5`. `atkRate` = 1.10 s (5× slower than original 0.22 s). |
