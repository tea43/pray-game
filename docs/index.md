...
- `planning/reworked_upgrade_plan.md`: Reworked slot-machine upgrade selector — lore-correct upgrade pools (Dick→weapons, Habib→armor, Elliot→alchemy), hidden spin-credit banking mechanic, and `UpgradeTestScene` dev harness.
